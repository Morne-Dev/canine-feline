...
<template>
    <div class="min-w-[1150px] bg-gray-100 h-full">
        <div class="flex items-center bg-gray-900 h-[70px] py-2 fixed z-50 min-w-[1150px] w-full">
            ...
            <div class="flex">
                <Link class="text-white h-[50] p-2 pt-10 border-[1px] border-transparent rounded-sm hover:border-gray-100 cursor-pointer">
                    Canine & Feline
                </Link>
            </div>
            ...
            <div class="text-white h-[50] p-2 pt-1 border-[1px] border-transparent rounded-sm hover:border-gray-100 cursor-pointer">
