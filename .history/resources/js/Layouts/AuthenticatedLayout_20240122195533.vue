...
<template>
    <div class="min-w-[1150px] bg-gray-100 h-full">
        <div class="flex items-center bg-gray-900 h-[60px] py-2 fixed z-50 min-w-[1150px] w-full">
            ...
            <div class="text-white py-3 px-2 border-[1px] border-transparent rounded-sm hover:border-gray-100 cursor-pointer">
                <div class="flex items-center justify-center">
                    <MapMarkerOutlineIcon class="pt-2 -ml-1" fillColor="#f5f5f5"/>
                    <div>
                        <div class="text-[13px] text-gray-300 font-extrabold">
                            <div>Deliver to Morne</div>
                        </div>
                        <div class="text-[15px] text-white font-extrabold">
                            <div>South Africa CPT STR</div>
                        </div>
                    </div>
                </div>
            </div>
